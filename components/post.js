...
export default function Post({post}) {
  return (
    <div className="flex cursor-pointer border-b border-gray-200">
      {/* image */}
      <img className="h-11 w-11 rounded-full mr-4" src={post.userimage} alt="user-img"/>
      {/* right container */}
      <div className="">
        {/* header */}
             ...
             {/* post text */}
             <p className="text-gray-800 text-[15px] sm:text-[16] p-2">{post.text}</p>
             {/* post image */}
             <img className="rounded-2xl  " src={post.img} />
